nlcnumber                       = "NLC000883"
prefix                          = "vk-vdsh" # Used by Azure Resource VM name only
resource_group_name             = "rg-spoke-visserskoning-avd-sessionhosts-prd-weu-001" # Deploy session hosts resources in this resource group
avd_subnet_id                   = "/subscriptions/63cf28ad-7dcb-431b-a539-58a6e358db3d/resourceGroups/rg-spoke-visserskoning-network-prod-weu-001/providers/Microsoft.Network/virtualNetworks/vnet-spoke-visserskoning-prod-weu-001/subnets/snet-visserskoning_avd" # Place the session hosts in this subnet

avd_host_pool_name              = "vdpool-generic-prd-weu-001" # Add session hosts to this Host Pool
avd_host_pool_id                = "/subscriptions/63cf28ad-7dcb-431b-a539-58a6e358db3d/resourceGroups/rg-spoke-visserskoning-avd-prod-weu-001/providers/Microsoft.DesktopVirtualization/hostPools/vdpool-generic-prd-weu-001" # We unfortunately need to specify the Host Pool ID because there is still no Terraform Data object to retrieve it
...
avd_ou_path                     = "OU=VK-PRD,OU=AVD,OU=Servers,OU=Maintenance,DC=schgoe,DC=local"
...
dcr_id                          = "/subscriptions/63cf28ad-7dcb-431b-a539-58a6e358db3d/resourceGroups/rg-spoke-visserskoning-avd-prod-weu-001/providers/Microsoft.Insights/dataCollectionRules/dcr-avd-sessionhost-monitoring"
dcr-vmi_id                      = "/subscriptions/63cf28ad-7dcb-431b-a539-58a6e358db3d/resourceGroups/rg-spoke-visserskoning-avd-prod-weu-001/providers/Microsoft.Insights/dataCollectionRules/dcr-avd-vminsights"
