nlcnumber                       = "NLC000883" # Supply the NLC numbersessionhosts
...
avd_ou_path                     = "OU=prd,OU=AVD,OU=Servers,OU=Maintenance,DC=schgoe,DC=local" # Supply the OU path where the avd session hosts should be added (ex. OU=AVD,OU=Azure,DC=adds,DC=dummy,DC=domain)
...
enable_dcr                      = true # Set to false if you don't want to assign data collection rules for monitoring
