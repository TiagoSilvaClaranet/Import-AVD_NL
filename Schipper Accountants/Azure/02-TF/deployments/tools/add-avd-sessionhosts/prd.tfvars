...
resource_group_name             = "rg-spoke-schipper-avd-sessionhosts-prd-weu-001" # Deploy session hosts resources in this resource group
...
source_image_id                 = "/subscriptions/63cf28ad-7dcb-431b-a539-58a6e358db3d/resourceGroups/rg-spoke-schipper-avd-prod-weu-001/providers/Microsoft.Compute/galleries/sigavdprodweu65fv/images/NLC000883-AVD-GOLDENVM-01-v01" # Specify the SIG image to use
...
avd_ou_path                     = "OU=PRD,OU=AVD,OU=Servers,OU=Maintenance,DC=schgoe,DC=local"

avd_host_pool_size              = 25 # Number of session hosts to deploy
