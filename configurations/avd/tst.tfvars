...
resource_group_name             = "rg-spoke-schipper-avd-sessionhosts-tst-weu-001" # Deploy session hosts resources in this resource group
...
avd_ou_path                     = "OU=tst,OU=AVD,OU=Servers,OU=Maintenance,DC=schgoe,DC=local" # Supply the OU path where the avd session hosts should be added (ex. OU=AVD,OU=Azure,DC=adds,DC=dummy,DC=domain)
